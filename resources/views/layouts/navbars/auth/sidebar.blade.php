<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">Mariela Baldivieso</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('user-profile') ? 'active' : '' }} " href="{{ url('user-profile') }}">
                    ...
                    <span class="nav-link-text ms-1">Perfil Mariela Baldivieso</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('tables') ? 'active' : '' }}" href="{{ url('tables') }}">
                    ...
                    <span class="nav-link-text ms-1">Comunidades y Barrios</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('tables') ? 'active' : '' }}" href="{{ url('tables') }}">
                    ...
                    <span class="nav-link-text ms-1">Proyectos de Ley</span>
                </a>
            </li>
        </ul>
    </div>
